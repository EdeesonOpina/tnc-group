...
class StorageController extends Controller
{
    public function show(Request $request)
    {
        $inventories = Inventory::leftJoin('items', 'inventories.item_id', 'items.id')
                            ...
                            ->select('inventories.*')
                            ->where('categories.id', Category::COMPONENTS)
                            ->where('sub_categories.id', SubCategory::STORAGE)
        ...
        return view('front.build.storage', compact(
            'build_items_total',
            'build_items',
            'inventories'
        ));
    ...
    public function search(Request $request)
    {
        ...
        return redirect()->route('build.storage.filter', [$name, $brand_id, $category_id, $sub_category_id])->withInput();
    }
    ...
    public function create(Request $request, $inventory_id)
    {
        ...
        return redirect()->route('build.result');
    }
}
