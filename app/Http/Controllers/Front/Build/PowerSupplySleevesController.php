...
class PowerSupplySleevesController extends Controller
{
    public function show(Request $request)
    {
        $inventories = Inventory::leftJoin('items', 'inventories.item_id', 'items.id')
                            ...
                            ->select('inventories.*')
                            ->where('sub_categories.id', SubCategory::POWER_SUPPLY_SLEEVES)
        ...
        return view('front.build.power-supply-sleeves', compact(
            'build_items_total',
            'build_items',
            'inventories'
        ));
    ...
    public function search(Request $request)
    {
        ...
        return redirect()->route('build.power-supply-sleeves.filter', [$name, $brand_id, $category_id, $sub_category_id])->withInput();
    }
    ...
    public function create(Request $request, $inventory_id)
    {
        ...
        return redirect()->route('build.graphics');
    }
}
