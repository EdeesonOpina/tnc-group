...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.air-cooling.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Air Cooling</h3>
						<a href="{{ route('build.aio') }}"><i class="ti-angle-double-left"></i> Go back to AIO</a><br>
						<a href="{{ route('build.aux-fan') }}"><i class="ti-angle-double-right"></i> Skip choosing Air Cooling</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.air-cooling.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
