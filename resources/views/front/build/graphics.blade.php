...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.graphics.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Graphics Card</h3>
						<a href="{{ route('build.power-supply-sleeves') }}"><i class="ti-angle-double-left"></i> Go back to Power Supply Sleeves</a><br>
						<a href="{{ route('build.aio') }}"><i class="ti-angle-double-right"></i> Skip choosing Graphics Card</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.graphics.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
