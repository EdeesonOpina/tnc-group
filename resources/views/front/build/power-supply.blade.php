...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.power-supply.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Power Supply</h3>
						<a href="{{ route('build.memory') }}"><i class="ti-angle-double-left"></i> Go back to Power Supply</a><br>
						<a href="{{ route('build.power-supply-sleeves') }}"><i class="ti-angle-double-right"></i> Skip choosing Power Supply</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.power-supply.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
