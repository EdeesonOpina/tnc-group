...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.aux-fan.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Aux Fan</h3>
						<a href="{{ route('build.air-cooling') }}"><i class="ti-angle-double-left"></i> Go back to Air Cooling</a><br>
						<a href="{{ route('build.monitor') }}"><i class="ti-angle-double-right"></i> Skip choosing Aux Fan</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.aux-fan.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
