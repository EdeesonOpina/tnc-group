...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.memory.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Memory</h3>
						<a href="{{ route('build.processor') }}"><i class="ti-angle-double-left"></i> Go back to Processor</a><br>
						<a href="{{ route('build.power-supply') }}"><i class="ti-angle-double-right"></i> Skip choosing Memory</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.memory.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
