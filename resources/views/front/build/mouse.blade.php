...
<main>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.mouse.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Mouse</h3>
						<a href="{{ route('build.keyboard') }}"><i class="ti-angle-double-left"></i> Go back to Keyboard</a><br>
						<a href="{{ route('build.headset') }}"><i class="ti-angle-double-right"></i> Skip choosing Mouse</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.mouse.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
