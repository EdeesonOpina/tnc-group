...
<main>
			...
			<div class="page_header">
				<div class="breadcrumbs">
					<ul>
						...
						<li>Power Supply Sleeves</li>
					</ul>
				</div>
				<h1>Power Supply Sleeves</h1>
			</div>
			<!-- /page_header -->
		</div>
	</div>
	...
	<div class="container margin_30">
		<div class="row">
			<div class="col-md-7">
				<form action="{{ route('build.power-supply-sleeves.search') }}" method="post">
					{{ csrf_field() }}
				<div class="row">
					<div class="col-md-7">
						<h3>Power Supply Sleeves</h3>
						<a href="{{ route('build.power-supply') }}"><i class="ti-angle-double-left"></i> Go back to Power Supply</a><br>
						<a href="{{ route('build.graphics') }}"><i class="ti-angle-double-right"></i> Skip choosing Power Supply Sleeves</a>
					</div>
					<div class="col">
				...
				<table class="table table-striped cart-list">
					...
					<tbody>
						...
						<tr>
							...
							<td class="options">
								<a href="{{ route('build.power-supply-sleeves.create', [$inventory->id]) }}"><i class="ti-shopping-cart"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
