...
<h3 style="font-family: sans-serif; font-weight: bold; margin: 0; Margin-bottom: 15px;">You have a pending BRF for checking. Here are the BRF details:</h3>
...
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
  Upon approval of the supervisor, the requestor must receive an email indicating that the request has been approved by the supervisor and is now for the final approva
</p>
