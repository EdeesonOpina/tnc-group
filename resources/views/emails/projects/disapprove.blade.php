...
<h3 style="font-family: sans-serif; font-weight: bold; margin: 0; Margin-bottom: 15px;">Your cost estimate - {{ $project->reference_number }} has been disapproved by {{ auth()->user()->firstname }} {{ auth()->user()->lastname }} for the following reason:</h3>
