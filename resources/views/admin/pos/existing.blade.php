        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('pos') }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('pos.customer.existing') }}">POS</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Dashboard</li>
                </ol>
            </nav>
            <h1 class="m-0">POS - Dashboard</h1>
        </div>
    </div>
</div>
...
<div class="container-fluid page__container">
    ...
    <div class="row">
            ...
            <div id="spaced-card" class="card card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="{{ route('pos.customer.new') }}">
                                    <button class="btn btn-light form-control">New</button>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ route('pos.customer.existing') }}">
        ...
        <div class="col-md-7">
            <form action="{{ route('pos.customer.existing.search') }}" method="post">
                {{ csrf_field() }}
                <div class="card card-form d-flex flex-column flex-sm-row">
                    <div class="card-form__body card-body-form-group flex">
                        ...
                        <div class="row">
                            <div class="col">
                                <label><a href="{{ route('pos.customer.existing') }}" id="no-underline">Clear Filters</a></label>
                            </div>
                        </div>
                    </div>
