        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bulk</li>
                </ol>
            </nav>
            <h1 class="m-0">POS - Bulk</h1>
        </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="{{ route('pos.bulk', [$user->id]) }}">
                                    <button class="btn btn-primary form-control">Bulk</button>
                                </a>
                            </div>
                        </div>
                        <br>
                        <form action="{{ route('pos.bulk.scan', [$user->id]) }}" method="post" id="form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_numbers[]" class="form-control" placeholder="Scan or enter by barcode serial number" value="{{ old('serial_number') }}">

                                    <div id="serial-div"><br></div>
...
<script type="text/javascript">
  $(function () {
    ...
    $("#add-more").click(function () {
      $("#serial-div").append("<input type='text' name='serial_numbers[]' class='form-control' placeholder='Scan or enter by barcode serial number'  required><br>");
    });
  })
</script>