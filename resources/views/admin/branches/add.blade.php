...
<form action="{{ route('admin.branches.create') }}" method="post" id="form" enctype="multipart/form-data">
{{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Branch Name" value="{{ old('name') }}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
