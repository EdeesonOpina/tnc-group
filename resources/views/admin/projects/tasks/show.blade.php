                        ...
                        <tbody class="list" id="companies">
                            @foreach ($project_tasks as $project_task)  
                                <tr>
                                    ...
                                    <td id="compact-table"><a href="#" data-toggle="modal" data-target="#edit-task-{{ $project_task->id }}" id="table-clickable">{{ $project_task->priority }}</a></td>
                                    <td id="compact-table">
                                        @if ($project_task->deadline_date)
                                            <a href="#" data-toggle="modal" data-target="#edit-task-{{ $project_task->id }}" id="table-clickable">{{ Carbon::parse($project_task->deadline_date)->format('M d Y') }}</a>
                                        @endif
                                    </td>
                                    <td id="compact-table">
