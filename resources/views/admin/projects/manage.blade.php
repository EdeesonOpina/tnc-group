                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        {{ Carbon::parse($project->start_date)->format('M d Y') ?? null }}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        {{ Carbon::parse($project->end_date)->format('M d Y') ?? null }}
                                    </div>
                                </div>
                                        ...
                                        <td id="compact-table">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                @if ($pjd->status == ProjectDetailStatus::APPROVED)
                                                    @if (auth()->user()->id == $project->created_by_user_id || auth()->user()->id == $project->prepared_by_user_id || auth()->user()->id == $project->noted_by_user_id || auth()->user()->role == 'Super Admin' || auth()->user()->role == 'Admin')
