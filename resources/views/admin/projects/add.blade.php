                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label>ASF (%)</label>
                                    <input type="text" name="margin" class="form-control" placeholder="ASF (%)" value="{{ old('margin') ?? 1 }}">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>VAT (%)</label>
                                    <input type="text" name="vat_rate" class="form-control" placeholder="VAT (%)" value="{{ old('vat_rate') ?? 1 }}">
                                </div>
                            </div>
                        </div>
