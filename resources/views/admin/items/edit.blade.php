...
<form action="{{ route('admin.items.update') }}" method="post" id="form" enctype="multipart/form-data">
{{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_code" class="form-control" placeholder="Item Code" value="{{ old('item_code') ?? $item->code }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="brand" name="brand_id" class="custom-select" data-toggle="select">
                                        <option value="{{ $curr_brand->id }}">{{ $curr_brand->name }}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="sub_category" name="sub_category_id" class="custom-select" data-toggle="select">
                                        <option value="{{ $curr_sub_category->id }}">{{ $curr_sub_category->name }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="tiny" name="description" placeholder="Enter your description here">{{ old('description') ?? $item->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
