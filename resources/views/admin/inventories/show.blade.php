...
<div class="container-fluid page__container">
    ...
    <form action="{{ route('internals.inventories.branches.search') }}" method="post">
        {{ csrf_field() }}
                            ...
                            @foreach($branches as $branch)
                                <tr>
                                    ...
                                    <td id="compact-table">
                                        <b>{{ $branch->name }}</b>
                                        <div class="d-flex">
                                            <a href="{{ route('internals.inventories.view', [$branch->id]) }}" style="margin-right: 7px">View</a> | 
                                            <a href="{{ route('internals.inventories.manage', [$branch->id]) }}" id="space-table">Manage</a> 
                                        </div>
                                    </td>
