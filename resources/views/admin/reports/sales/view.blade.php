@php
  ...
  $overall_pos_online_transfer_total = 0;
      ...
      <tbody>
        ...
        @php
            ...
            if ($payment->status == PaymentStatus::DELIVERED) {
                ...
                if ($payment->mop == 'online-transfer') {
                  $overall_pos_online_transfer_total += $total_with_deductions;
                }
            ...
            foreach($payment_items as $payment_item) {
              if ($payment_item->status == PaymentStatus::DELIVERED) {
                ...
                */
                ...
                $landing_price = $payment_item->cost;
        ...
        <tr>
          ...
          <td>
            ...
            @if($payment_receipt->note != 'none')
              <br>{{ $payment_receipt->note }}
            @endif
          </td>
        </tr>
        @endforeach
