...
<div class="container page__heading-container">
    <div class="page__heading d-flex align-items-center">
        ...
        @if ($return_inventory->status == ReturnInventoryStatus::ON_PROCESS)
            <a data-href="{{ route('internals.rma.for-warranty', [$return_inventory->reference_number]) }}" data-toggle="modal" data-target="#confirm-action">
            ...
            <div id="spaced-card" class="card card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Item</label>
                            <input type="text" name="inventory_id" class="form-control" placeholder="Name" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Qty</label>
                            <input type="text" name="qty" class="form-control" placeholder="Qty" min="1" disabled>
                        </div>

                        <div class="form-group">
                            <label>Remarks</label>
                            <textarea class="form-control" placeholder="Enter remarks here" disabled></textarea>
                        </div>

                        <div class="form-group">
                            <button type="button" class="form-control btn btn-success" disabled>Save</button>
                        </div>
                    </div>
                </div>
            </div>
