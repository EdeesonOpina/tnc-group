...
<div class="container-fluid page__container">
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{ route('internals.rma.suppliers.search', [$return_inventory->reference_number]) }}" method="post">
                {{ csrf_field() }}
                ...
                <div class="card card-form d-flex flex-column flex-sm-row">
                    <div class="card-form__body card-body-form-group flex">
                        ...
                        <div class="row">
                            <div class="col">
                                <label><a href="{{ route('internals.rma.suppliers', [$return_inventory->reference_number]) }}" id="no-underline">Clear Filters</a></label>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach($suppliers as $supplier)
                                <tr>
                                    <td id="compact-table">
                                        <div class="d-flex">
                                            @if ($supplier->image)
                                                <img src="{{ url($supplier->image) }}" width="40">
                                            @else
                                    ...
                                    <td id="compact-table">
                                        <strong>ID:</strong><div class="badge badge-light">#{{ $supplier->id }}</div><br>
                                        <strong>{{ $supplier->name }}</strong><br>
                                        {{ $supplier->line_address_1 }}<br>
                                        @if ($supplier->line_address_2)
                                            {{ $supplier->line_address_2 }}<br>
                                        @endif
                                        {{ $supplier->mobile }} / {{ $supplier->phone }}<br>
                                        <div class="d-flex">
                                            <a href="{{ route('internals.rma.suppliers.select', [$return_inventory->reference_number, $supplier->id]) }}">Select</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
