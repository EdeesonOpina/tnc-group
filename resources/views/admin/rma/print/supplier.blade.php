                    ...
                    <tr>
                        <td class="text-left">
                            <strong class="text-body">RMA#</strong>
                                {{ $return_inventory->reference_number }}<br>
                                ...
                                @if ($return_inventory->goods_receipt)
                                    ...
                                    @if ($return_inventory->goods_receipt->purchase_order->supplier->line_address_1)
                                        {{ $return_inventory->goods_receipt->purchase_order->supplier->line_address_1 }}<br>
                                    @endif
                                    @if ($return_inventory->goods_receipt->purchase_order->supplier->line_address_2)
                                ...
                                @elseif ($return_inventory->supplier)
                                    <strong class="text-body">{{ $return_inventory->supplier->name }}</strong><br>
                                    {{ $return_inventory->supplier->line_address_1 }}<br>
                                    {{ $return_inventory->supplier->line_address_2 }}<br>
                                    @if ($return_inventory->supplier->phone)
                                        {{ $return_inventory->supplier->phone }} / 
                                    @endif
                                    @if ($return_inventory->supplier->mobile)
                        ...
                        <td class="text-right">
                            @if ($return_inventory->delivery_receipt_number)
                                <strong class="text-body">GRPO#</strong>
                                {{ $return_inventory->goods_receipt->reference_number }}<br>
                                <strong class="text-body">DR#</strong>
                                {{ $return_inventory->delivery_receipt_number }}<br>
                            @endif
                            <strong class="text-body">Date</strong>
                            {{ $return_inventory->created_at->format('M d Y') }}<br>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table border-bottom no-border table-borderless font-change">
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="text-label"><strong>RECEIVED BY</strong></div>
                        </td>
                    </tr>
                </tbody>
            </table>
