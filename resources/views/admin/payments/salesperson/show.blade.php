        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Assign Salesperson</li>
                </ol>
            </nav>
            <h1 class="m-0">Assign Salesperson</h1>
        </div>
    </div>
</div>
...
<div class="container-fluid page__container">
    ...
    <div class="row">
        <div class="col-md-8">
            <form action="{{ route('accounting.payments.salesperson.search', [$payment->so_number]) }}" method="post">
                {{ csrf_field() }}
                ...
                <div class="card card-form d-flex flex-column flex-sm-row">
                    <div class="card-form__body card-body-form-group flex">
                        ...
                        <div class="row">
                            <div class="col">
                                <label><a href="{{ route('accounting.payments.salesperson', [$payment->so_number]) }}" id="no-underline">Clear Filters</a></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tbody class="list" id="companies">
                            ...
                            @php
                                $payments_count = Payment::where('user_id', $user->id)->count();
                            @endphp
                                <tr>
                                    <td id="compact-table">
                                    ...
                                    <td id="compact-table">
                                        <a href="{{ route('accounting.payments.salesperson.assign', [$payment->so_number, $user->id]) }}">
