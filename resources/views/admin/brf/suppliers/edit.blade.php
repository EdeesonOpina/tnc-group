...
<form action="{{ route('internals.brf.suppliers.update') }}" method="post" id="form" enctype="multipart/form-data">
{{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="payment_for_supplier_id" class="custom-select" data-toggle="select" name="payment_for_supplier_id">
                                        <option value="{{ $budget_request_form->payment_for_supplier->id }}">{{ $budget_request_form->payment_for_supplier->name }}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="requested_by_user_id" class="custom-select" data-toggle="select" name="requested_by_user_id">
