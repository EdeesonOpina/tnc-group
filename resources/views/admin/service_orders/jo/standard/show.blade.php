            ...
            <div id="spaced-card" class="card card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="{{ route('pos.standard', [$user->id]) }}">
                                    <button class="btn btn-primary form-control">Standard</button>
                                </a>
                            </div>
                        ...
                        <br>
                        <form action="{{ route('pos.standard.scan', [$user->id]) }}" method="post" id="form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_number" class="form-control" placeholder="Scan or enter by barcode serial number" value="{{ old('serial_number') }}">
                                </div>
                            </div>
                        </div>
