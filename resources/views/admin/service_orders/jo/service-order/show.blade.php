        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('jo') }}"><i class="material-icons icon-20pt">home</i></a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jo.customer.new') }}">JO</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Job Orders</li>
                </ol>
            </nav>
            <h1 class="m-0">Job Order</h1>
        </div>
            ...
            <div id="spaced-card" class="card card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <h3>Job Order</h3>
                        <br>
                        <form action="{{ route('jo.service-order.details.create', [$user->id]) }}" method="post" id="form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="name" class="form-control" placeholder="Enter Item Description" autofocus required>{{ old('name') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_number_notes" class="form-control" placeholder="Enter S/N here" value="{{ old('serial_number_notes') }}" min="1">
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach ($service_order_details as $service_order_detail)
                                        <tr>
                                            <td>
                                                ...
                                                <a href="#" data-href="{{ route('jo.service-order.details.delete', [$user->id, $service_order_detail->id]) }}" class="text-danger" data-toggle="modal" data-target="#confirm-action"><i class="material-icons" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete">delete</i></a>
                                                <br>
