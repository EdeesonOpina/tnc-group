...
@if ($cv->budget_request_form)
  <form action="{{ route('internals.brf.mark-as-released') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <input type="hidden" name="budget_request_form_id" value="{{ $cv->budget_request_form->id }}">
    <div class="modal fade" id="mark-as-released-{{ $cv->budget_request_form->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-4">
                  @if ($cv->budget_request_form->project->image)
                      <img src="{{ url($cv->budget_request_form->project->image) }}" width="100%">
                  @else
              ...
              <div class="col">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    {{ $cv->budget_request_form->project->client->name }}
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                  ...
                  <div class="col">
                    {{ $cv->budget_request_form->project->end_date }}
                  </div>
                </div>
                <hr>
