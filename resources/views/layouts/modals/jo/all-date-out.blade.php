...
<form action="{{ route('operations.service-orders.assign.date-out') }}" method="post">
  ...
  <div class="modal fade" id="date-out-{{ $service_order->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          <h5 class="modal-title" id="exampleModalLabel">Assign Date Out</h5><br>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <input type="date" name="date_out" class="form-control" value="{{ Carbon::now()->format('Y-m-d') ?? old('date_out') }}">
            </div>
          </div>
