<form action="{{ route('accounting.payments.update.vat') }}" method="post">
  {{ csrf_field() }}
  <input type="hidden" name="so_number" value="{{ $payment_receipt->so_number }}">
  <div class="modal fade" id="edit-vat-{{ $payment_receipt->so_number }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          <h5 class="modal-title" id="exampleModalLabel">Edit VAT</h5><br>
