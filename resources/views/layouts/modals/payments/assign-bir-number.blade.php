...
<form action="{{ route('accounting.payments.assign.bir-number') }}" method="post">
  ...
  <div class="modal fade" id="assign-bir-number-{{ $payment->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <input type="text" name="bir_number" class="form-control" placeholder="OR Number" value="{{ old('bir_number') ?? $payment->bir_number }}"><br>
            </div>
          </div>
