...
<div class="mdk-drawer-layout__content page">
        ...
        <div class="bg-primary" style="min-height: 150px;">
            <div class="d-flex align-items-end container-fluid page__container" style="position: absolute; left: 0; right: 0; bottom: 0;">
                <div class="avatar avatar-xl">
                    @if (auth()->user()->avatar)
                        <img src="{{ url(auth()->user()->avatar) }}" alt="avatar" class="avatar-img rounded" style="border: 2px solid white;">
                    @else
    ...
    <div class="container-fluid page__container">
        <div class="row">
            <div class="col-lg-3">
                <h1 class="h4 mb-1">{{ auth()->user()->firstname }} {{ auth()->user()->lastname }}</h1>
                <p>{{ auth()->user()->role }}</p>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex">{{ auth()->user()->country->name }}</div>
                </div>
            </div>
            <div class="col-lg-9">
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="flex">
                                        <div class="d-flex align-items-center mb-1">
                                            <strong class="text-15pt">{{ auth()->user()->name }}</strong>
