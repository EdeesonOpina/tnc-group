  ...
  <body class="layout-login-centered-boxed">
    <div class="layout-login-centered-boxed__form card">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-5 navbar-light">
            <a href="{{ route('login') }}" class="navbar-brand flex-column mb-2 align-items-center mr-0" style="min-width: 0">
                <img class="navbar-brand-icon mr-0 mb-0" src="{{ url(env('APP_IMAGE')) }}" width="250" alt="{{ env('APP_NAME') }}">
                <!-- <span>{{ env('APP_NAME') }}</span> -->
            </a>
        </div>

            <div class="form-group">
                <p class="m-0">You have successfully registered to {{ env('APP_NAME') }}.</p>
                <p class="m-0">Please do check your <b>INBOX</b> or <b>SPAM</b> folder for your verification link.</p><br>
            </div>
